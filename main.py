...
def test_objects() -> None:
    archer_1 = Archer(name="archer_1", X=1, Y=1)
    archer_2 = Archer(name="archer_2", X=1, Y=1)
    fort = Fort(name="fort_1", X=12, Y=15, is_build=True)
    mobile_house = MobileHouse(name="mobile_house_1", X=14, Y=20, is_build=True)
